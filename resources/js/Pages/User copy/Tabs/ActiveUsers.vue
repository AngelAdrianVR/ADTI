                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item
                                    ...
                                    <svg v-if="scope.row.is_active" class="size-4 mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg v-else class="size-4 mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
