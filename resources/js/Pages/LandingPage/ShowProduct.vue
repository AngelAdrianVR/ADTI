<template>
    <PublicLayout :title="'Detalles de producto'">
        <main class="px-2 lg:p-8 xl:px-48 py-7 mx-auto">
            ...
            <!-- Decorations  -->
            <figure>
                <img class="hidden md:block absolute top-40 left-0 z-0" src="@/../../public/images/home_decoration1.png" alt="">
                <!-- <img class="hidden md:block absolute top-20 left-0 z-0" src="@/../../public/images/home_decoration2.png" alt=""> -->
                <img class="hidden md:block absolute top-20 right-0 z-0" src="@/../../public/images/home_decoration3.png" alt="">
            </figure>
            <!-- ------------ -->
            ...
            <div class="md:grid xl:grid-cols-2 gap-x-28 mx-2 md:mx-6">
                ...
                <section>
                    <figure class="border h-64 md:h-[420px] md:w-[500px] w-[390px] border-grayD9 rounded-lg flex justify-center items-center bg-white z-50">
                ...
                <section class="my-3 lg:my-5">
                    ...
                    <p class="text-primary">Número de parte del fabricante: {{ product.part_number_supplier }}</p>
                    ...
                    <div class="flex flex-col mt-7 border-y py-2 w-2/3">
