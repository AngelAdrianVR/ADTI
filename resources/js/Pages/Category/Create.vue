            ...
            <form @submit.prevent="store" class="rounded-lg border border-grayD9 lg:p-5 p-3 lg:w-1/2 mx-auto mt-2">
                ...
                <section>
                    <article class="flex items-center space-x-4">
                        <InputLabel class="w-[20%]" value="Subcategoría 1" />
                        <el-input v-model="form.name" placeholder="Ej. Movimiento lineal" :maxlength="255" clearable />
                        <div class="flex items-center space-x-2">
                ...
                <button class="text-primary">+ Agregar subcategoría</button>
