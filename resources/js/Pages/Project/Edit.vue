                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                            <el-icon class="text-[#1676A2]"><EditPen /></el-icon>
                            Editar Proyecto
                        </h1>
                        <p class="text-sm text-gray-500">Modifica los detalles generales y ajusta el presupuesto de tareas.</p>
                    </div>
                ...
                >
                                    ...
                                    <div class="col-span-3">
                                        ...
                                        >
                                            <el-select 
                                                ...
                                                size="default"
                                                filterable
                                                :no-data-text="'Sin departamentos'"
                                            >
                                                <el-option 
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        ...
                        <el-button 
                            ...
                            color="#1676A2"
                        >
                            <el-icon class="mr-2"><CircleCheck /></el-icon> Guardar Cambios
                        </el-button>
                    </div>
